...
elo.result <- RunElo(all.games, team.dictionary, team.data,
                     ...
                     param.margin = 0.02896568, 
                     param.coeff.rating.update = 62.5, param.regress.rating = 0.2155, 
                     param.time.window = 2, param.coeff.wins = 0, param.coeff.other = 3.8,
                     param.coeff.travel = 22.3,
                     param.rating.expansion.init = 1300,
